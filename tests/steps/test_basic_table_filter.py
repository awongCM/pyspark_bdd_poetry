...
def given_table(spark: SparkSession, table_name: str, table: str) -> DataFrame:
...
def select_query_from_source_table(spark: SparkSession, source_table: str, field: str, threshold: str, dest_table: str) -> DataFrame:
...
def display_destination_table_output(spark: SparkSession, table_name: str, table: str) -> None:
